...
namespace Jan2018DemoWebsite.SamplePages
{
    public partial class AlbumDetails : System.Web.UI.Page
    {
        ...
        {
            //do the following on the first time through
            //this page
            if(!Page.IsPostBack)
            {
                //Response.Redirect sent a value to this page
                //Request.QueryString["Labeled "] will obtain the value sent gy redirect
                //The value is a string
                //If no values was sent the value will be null.
        ...
        protected void AlbumTracks_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            // value that was attach to the button to the link on the
            // listview row
